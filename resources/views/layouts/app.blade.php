...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="{{ asset('images/bay_favicon.png') }}" type="image/gif" sizes="20x20">
    ...
    >
        ...
        <div class="flex h-screen overflow-hidden">
            ...
            <x-app.sidebar  :accountable_form_types_of_user="$accountable_form_types_of_user" :message_count="$message_count" />
