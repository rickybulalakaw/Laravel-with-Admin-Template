<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="extension" type="text" class="mt-1 block w-full" wire:model.defer="state.extension" autocomplete="extension" />
            <x-jet-input-error for="extension" class="mt-2" />
        </div>
